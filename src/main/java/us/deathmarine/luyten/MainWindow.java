	...
	private String getLegalStr()
	{
		...
		try
		{
			BufferedReader reader = new BufferedReader(
					new InputStreamReader(getClass().getClassLoader().getResourceAsStream("Procyon.License.txt")));
			String line;
			...
			reader = new BufferedReader(
					new InputStreamReader(getClass().getClassLoader().getResourceAsStream("RSyntaxTextArea.License.txt")));
			while ((line = reader.readLine()) != null)
			{
				sb.append(line).append("\n");
			}
